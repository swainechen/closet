...
# --config ACC=SG-M84
# --config REF=/home/slchen/Documents/Projects/GBS/SRA/CP012419.2.fna
assert 'ACC' in config, ("required --config ACC=xyz missing")
assert 'REF' in config, ("required --config REF=xyz missing")
assert 'SPECIES' in config, ("required --config SPECIES=xyz missing")
